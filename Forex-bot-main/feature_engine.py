...
class FeatureEngine:
    ...
    def generate_features(self, df):
        ...
        # data.columns = [c.capitalize() for c in data.columns]  # REMOVED: Causes mismatch with model features
        ...
        data['Efficiency_Ratio'] = (direction / volatility).replace([np.inf, -np.inf], 0)
        ...
        # Note: Modified to prevent data leakage (no forward shifts).
        # We look back at the past 5 bars to identify recent peaks/troughs.
        data['Fractal_Up'] = (

...
from models.lstm_model import TradingLSTM, create_classification_sequences as create_sequences
...
def run_full_pipeline(ticker="EURUSD=X", 
    ...
    if model_type == 'xgboost':
        ...
        X, y = create_sequences(data_scaled, original_close, seq_length=seq_length)
